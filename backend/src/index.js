...
} from "../controllers/respostasAvaliativasController.js";
...
router.get("/respostas-avaliativas", authRequired, listRespostasAvaliativas);
router.post("/respostas-avaliativas", authRequired, submitRespostaAvaliativa);
