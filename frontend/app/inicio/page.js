...
export default function InicioPage() {
  ...
  const alertas = useMemo(() => {
    ...
    if (dados.totalTreinamentos === 0) {
      itens.push({ tipo: "atenção", texto: "Ainda não há treinamentos lançados para leitura executiva." });
    }
    ...
    >
      ...
      <section style={heroStyle}>
        <div>
          ...
          <h2 style={heroTitleStyle}>Painel gerencial do Tel T&amp;D</h2>
          <p style={heroTextStyle}>
            Acompanhe volume, qualidade, presença, percepção do treinamento e sinais de atenção
        ...
        <div style={metaGridStyle}>
          ...
          <MetaCard label="Meta Qualidade" value="4,5+" />
        </div>
      </section>
      ...
      <div style={cardsGrid}>
        ...
        <KpiCard title="Presenças" value={dados.totalPresencas} caption="Registros de participação" />
        <KpiCard title="Avaliações" value={dados.totalAvaliacoes} caption="Feedbacks recebidos" />
      ...
      <div style={twoColsStyle}>
        <Panel title="Leitura por Cliente" subtitle="Volume de treinamentos aplicados por operação">
        ...
        <Panel title="Leitura por Instrutor" subtitle="Volume de treinamentos aplicados por instrutor">
