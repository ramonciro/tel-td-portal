...
export default function AlterarSenhaPage() {
  ...
  return (
    <PortalShell
      title="Alterar senha"
      subtitle="Área para atualização segura da senha de acesso ao portal."
    >
      <SectionCard
        title="Atualização de senha"
        subtitle="Use esta página para ajustar sua credencial de acesso sem depender do primeiro acesso."
      >
        ...
        <form
          ...
          style={{ maxWidth: 560, display: "grid", gap: 14 }}
        >
          <input
            type="password"
