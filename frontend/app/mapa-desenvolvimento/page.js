        ...
        {activeTab === "geral" && (
          <div style={{ display: "grid", gap: 18 }}>
            ...
            <SectionCard
              ...
              subtitle="Leitura executiva das ações do mapa, sem dependência da página de turmas."
            >
              {loading ? (
        ...
        {activeTab === "acoes" && (
          <>
            <SectionCard
              ...
              subtitle="Cadastre ações com lançamento manual ou importação Excel, sem vínculo com a página de turmas."
            >
              <details open style={detailsCard}>
